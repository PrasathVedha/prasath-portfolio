        ...
        <div className="hidden md:flex items-center space-x-6">
          {['About', 'Projects', 'Skills', 'Experience', 'Contact'].map((item) => (
            <a
              ...
              className="text-sm font-medium text-gray-700 hover:text-data-blue transition-colors"
            >
              {item}
            </a>
          ))}
          ...
          <div className="flex flex-col space-y-3">
            {['About', 'Projects', 'Skills', 'Experience', 'Contact'].map((item) => (
              <a
                key={item}
                href={`#${item.toLowerCase()}`}
                className="text-gray-700 py-2 px-4 rounded-md hover:bg-gray-100 transition-colors"

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full bg-data-blue hover:bg-data-blue/90"
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91-9074347301</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">immanualjm24@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="data-card">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="h-12 w-12 rounded-full bg-[#0077B5]/10 flex items-center justify-center hover:bg-[#0077B5]/20 transition-colors"
                >
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    width="20" 
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="h-12 w-12 rounded-full bg-gray-800/10 flex items-center justify-center hover:bg-gray-800/20 transition-colors"
                >
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    width="20" 
                ...
                <a 
                  ...
                  className="h-12 w-12 rounded-full bg-red-500/10 flex items-center justify-center hover:bg-red-500/20 transition-colors"
                >
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    width="20" 
